    ...
    return (
        <div className="flex flex-col gap-5 p-5 lg:p-6">
            ...
            <div className="lg:hidden">
                <p className="text-xs font-semibold text-[#0060a9] mb-1">Good morning Sabir</p>
                <h1 className="text-xl font-semibold text-[#1a2a3a] leading-tight"
                    ...
                    {FACULTIES.map((faculty) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className={`text-[12px] mt-1 ${isActive ?
                                    "text-[#5a8bbf]"
                                    : "text-[#8a97a4]"
                                    }`}>{count} profs
                                </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                <div className="bg-white border border-[#e4eaf0] rounded-xl p-3 shadow-[0_1px_4px_rgba(0,40,80,0.04)]">
                    ...
                    <p className="text-xl font-semibold text-[#0060a9]">{filteredProfessors.length}</p>
                ...
                <div className="bg-white border border-[#e4eaf0] rounded-xl p-3 shadow-[0_1px_4px_rgba(0,40,80,0.04)]">
                    ...
                    <p className="text-xl font-semibold text-[#1a2a3a]">{totalReviews.toLocaleString()}</p>
                    <p className="text-[9px] text-[#8a97a4] mt-1">
                ...
                <div className="hidden lg:block bg-white border border-[#e4eaf0] rounded-xl overflow-hidden shadow-[0_1px_4px_rgba(0,40,80,0.04)]">
                    <div className="grid grid-cols-[40px_2.5fr_1fr_1fr_1fr] gap-2 px-4 py-2.5 border-b border-[#e4eaf0] bg-[#f8fafb]">
                        {["#", "Professor", "Rating", "Reviews", "Status"].map((h, i) => (
                            <span key={h} className={`text-[9px] text-[#8a97a4] uppercase tracking-wider ${i === 4 ? "text-right" : ""}`}>
                                {h}
                            </span>
                        ))}
                    </div>
                        ...
                        (
                            sortedProfessors.map((professor, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        <span className="text-[11px] text-[#8a97a4]">{index + 1}</span>
                                        <div className="flex items-center gap-2">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-[10px] text-[#8a97a4]">{professor.department}</p>
                                            </div>
                                        </div>
                                        <div>
                                                ...
                                                {[1, 2, 3, 4, 5].map((star) => (
                                                    <div
                                                        ...
                                                        style={{
                                                            ...
                                                            background: star <= Math.round(professor.overallRating) ? "#0060a9" : "#d8dfe6"
                                                        }}
                                                    ></div>
                                                ))}
                                            </div>
                                        ...
                                        <p className="text-[10px] text-[#8a97a4]">{professor.reviewCount} reviews</p>
                    ...
                    {sortedProfessors.length === 0 ? (
                        ...
                        sortedProfessors.map((professor, index) => {
                            ...
                            return (
                                ...
                                >
                                    <span className="text-[11px] text-[#8a97a4] w-3.5">{index + 1}</span>
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <p className="text-[10px] text-[#8a97a4] mt-0.5">{professor.department}</p>
                                    </div>
                                    <div className="text-right flex-shrink-0">
                                        <p className={`text-[15px] font-semibold ${getRatingColor(professor.overallRating)}`}>
                                            {formatRating(professor.overallRating)}
                                        </p>
                                        <p className="text-[9px] text-[#8a97a4] mt-0.5">{professor.reviewCount} reviews</p>
                                    </div>
                                </div>
                            );
                        })
