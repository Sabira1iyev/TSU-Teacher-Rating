...
export default function OnBoardingPage() {
    ...
    const slides = [
        ...
        },
        {
            ...
            iconBg: "bg-amber-dim",
            title: onBoarding("title7"),
            titleAccent: onBoarding("title8"),
            ...
            <div className="w-full max-w-md px-5 pt-8 pb-2 flex flex-col gap-3">
                <div className="flex gap-1.5">
                    {slides.map((_, i) => (
                        ...
                        >
                            <div
                                className={`h-full rounded-full transition-all duration-500 ${i <= current ? "bg-primary" : "bg-transparent"
                                    }`}
                            />
                        </div>
                    ))}
            ...
            <div className="flex-1 flex items-center justify-center w-full px-5 pb-10">
                <div className="w-full max-w-md bg-bg2 rounded-3xl shadow-[0_4px_32px_rgba(0,60,120,0.08)] px-7 py-10 flex flex-col items-center gap-6">
                    ...
                    {isLast && (
                        <div className="flex w-full justify-center items-center gap-0 bg-bg2 border border-border rounded-2xl overflow-hidden">
                            <div className="flex-1 py-4 text-center border-r border-border">
                                <div className="text-xl font-bold text-primary">{onBoarding("12k")}</div>
                                <div className="text-[11px] text-text3 mt-0.5 font-medium">{onBoarding("professors")}</div>
                            </div>
                            <div className="flex-1 py-4 text-center border-r border-border">
                                <div className="text-xl font-bold text-text">{onBoarding("48k")}</div>
                                <div className="text-[11px] text-text3 mt-0.5 font-medium">{onBoarding("reviews")}</div>
                            </div>
                            <div className="flex-1 py-4 text-center">
                                <div className="text-xl font-bold text-[#d4a017]">500+</div>
                                <div className="text-[11px] text-text3 mt-0.5 font-medium">{onBoarding("students")}</div>
                            </div>
                        </div>
                    )}
                    ...
                    <div className="flex flex-col items-center gap-3 w-full mt-2">
                        ...
                        >
                            {isLast ? buttons("signup") : buttons("continue")}
                        </button>
