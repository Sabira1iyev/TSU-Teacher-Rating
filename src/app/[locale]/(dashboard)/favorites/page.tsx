              ...
              {favorites.map((professor) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Avatar */}
                    <div
                      className={`w-11 h-11 rounded-full flex items-center justify-center text-sm font-semibold mb-3 ${colors.bg} ${colors.text}`}
                    >
                    ...
                    {/* Score */}
                    <p
                      className={`text-2xl font-semibold mt-3 ${getRatingColor(professor.overallRating)}`}
                    >
            ...
            <div className="flex lg:hidden flex-col gap-2">
              {favorites.map((professor) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`w-10 h-10 rounded-full flex items-center justify-center text-sm font-semibold flex-shrink-0 ${colors.bg} ${colors.text}`}
                    >
                      {getInitials(professor.firstName, professor.lastName)}
                    </div>
                    ...
                    <div className="text-right flex-shrink-0 mr-6">
                      <p
                        className={`text-base font-semibold ${getRatingColor(professor.overallRating)}`}
                      >
                        {formatRating(professor.overallRating)}
                      </p>
                      <p className="text-[10px] text-text3 mt-0.5">
