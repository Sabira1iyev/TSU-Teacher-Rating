            ...
            {professor ? (
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-col gap-2 h-auto overflow-y-auto">
                  {allProfessors.map((p) => {
                    const pColor =
                      FACULTY_COLORS[p.faculty] || DEFAULT_FACULTY_COLOR;
                    return (
                      <div
                        key={p.id}
                        onClick={() => {
                      ...
                      >
                        ...
                        <span
                          className={`ml-auto text-sm font-semibold ${getRatingColor(p.overallRating)}`}
                        >
            ...
            <>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full bg-bg2 border border-border rounded-xl px-4 py-3 text-sm text-text outline-none focus:border-primary transition-colors cursor-pointer appearance-none"
                >
